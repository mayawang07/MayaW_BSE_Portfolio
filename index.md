...
# Second Milestone
My second milestone was designing and building the servo tilt/pan. I didn't have any spare metal pieces in my house or in my project kit, so I decided to just use cardboard, zipties, and a hot glue gun. I spent a day or two just brainstorming and drawing (and sometimes trashing) design ideas. I came up with the design shown below after drawing some inspiration from [this design](https://content.instructables.com/ORIG/FBT/XOJD/GZDY7AI1/FBTXOJDGZDY7AI1.jpg?auto=webp&frame=1&width=1024&fit=bounds&md=d3c243628d753cd08d7d95415e2988c7) and using it as a reference.

![Laser Design](https://user-images.githubusercontent.com/55466693/128218813-3d14a4e9-810f-4f41-8b1a-e47befc82af1.jpg)

After finalizing the design, I began measuring and cutting the cardboard I had to make the parts. That wasn't too hard, and eventually I had cut all the pieces I needed. Sticking the breadboard on the cardboard base wasn't too hard; I simply peeled off the adhesive protective paper its backside and placed it in its assigned area on the board. However, the Arduino Uno definitely gave me a bit of trouble.
